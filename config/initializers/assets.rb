...
%w( user/homes user/comments user/contacts user/consultings user/products   admin/homes admin/comments admin/contacts admin/customers admin/consultings admin/products ).each do |controller|
