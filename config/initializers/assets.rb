...
%w( user/homes user/comments user/contacts user/consultings user/products user/interiorideas user/projects user/dashboards user/videos   admin/homes admin/comments admin/contacts admin/customers admin/consultings admin/products admin/interiorideas admin/projects admin/dashboards admin/videos admin/product_categories admin/project_categories admin/interioridea_categories admin/services ).each do |controller|
